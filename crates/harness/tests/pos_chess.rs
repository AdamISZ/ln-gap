//! The PoS absence-claim graph's chess scenario suite: PC1-PC13
//! (POS_FACTCHAIN_PLAN.md step 7; D42; D44; D45; D50). The scenarios live in
//! `lngap_harness::scenarios::pos_chess`. Run with `--test-threads=2`: thirteen
